...
//               className="flex w-full items-center justify-center rounded-md border border-blue-600 bg-white px-4 py-2 text-sm font-medium text-blue-600 hover:bg-blue-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
//             >
...
//             {showCreateMenu && (
//               <div className="absolute left-0 right-0 mt-2 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none z-50">
//                 <div className="py-1">
...
//                       <span className="ml-2 text-xs text-gray-500">1 host → 1 invitee</span>
//                     </div>
...
//                     <div className="flex items-center text-sm font-medium text-gray-900">
//                       <span>Group</span>
//                       <span className="ml-2 text-xs text-gray-500">1 host → Multiple invitees</span>
//                     </div>
...
//                       <span className="ml-2 text-xs text-gray-500">Rotating hosts → 1 invitee</span>
//                     </div>
...
//                       <button 
//                         className="flex items-center justify-center px-4 py-3 text-sm text-gray-600 hover:bg-gray-100 relative"
...
//                       </button>
//                       <button 
//                         className="flex items-center justify-center px-4 py-3 text-sm text-gray-600 hover:bg-gray-100"
//                         onClick={(e) => e.stopPropagation()}
//                       >
//                         <svg className="mr-2 h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
//                           <path
